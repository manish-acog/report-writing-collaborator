...
a vision-capable model. For whoever wires it into `src/report_writing_collaborator/agent/agent.py`
...
Implement `inspect_image` in `src/report_writing_collaborator/agent/agent.py`, add it to the
